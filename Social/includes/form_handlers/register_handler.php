...
$date = ""; //Sign up Date
$error_array = array(); //Holds error mesaages

if(isset($_POST['register_button'])){

	//Registration forms values
	...
	$_SESSION['reg_email2'] = $em2; //Stores email into session
...
if(strlen($fname) > 25 || strlen($fname) <2) {
	...
	array_push($error_array, "<span style='color: #14c800'> You're all set!</span><br>");
