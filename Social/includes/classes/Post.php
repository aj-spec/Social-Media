...
class Post {
	...
	public function __construct($con, $user){
		$this->con = $con;
		$this->user_obj = new user($con, $user); //within class creating instance of user class
	}
	...
	public function loadPostsFriends() {
		...
		while($row = mysqli_fetch_array($data)) {
			...
			if($interval->y == 1) {
				if($interval == 1)
					$time_message = $internal->y."year ago"; //1 year ago
				else
				...
				if($interval->m == 1) {
					...
					$time_message = $internal->m."months".$days;
				}
