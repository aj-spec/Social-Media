						...
						<script>
							$(document).ready(function() {
								...
								$('#post<?php echo $id; ?>').on('click', function()) {
									bootbox.comfirm("Are you sure you want to delete this post?", function(result) {

										$.post("includes/forms/form_handlers/delete_post.php?post_id=<?php echo $id; ?>", {result:result});
